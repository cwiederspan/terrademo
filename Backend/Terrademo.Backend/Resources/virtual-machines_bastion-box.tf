...
# Title: A Bastion Box
# Description: This example provisions a Bastion Box, which is located in it's own Subnet with a Public IP Address - which has SSH access to the other internal subnets (in this case a placeholder `web` subnet).
