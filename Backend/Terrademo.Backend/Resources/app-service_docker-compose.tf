...
# Title: Linux App Service running multiple containers from a Docker Compose file.
# Description: This example provisions a Linux App Service which runs multiple Docker Containers from Docker Compose file.
