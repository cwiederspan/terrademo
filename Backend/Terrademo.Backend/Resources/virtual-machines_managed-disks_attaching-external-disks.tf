...
# Title: Virtual Machine with Data Disks
# Description: This example provisions a Virtual Machine with 2 Data Disks and an OS Disk all of which are Managed Disks.
