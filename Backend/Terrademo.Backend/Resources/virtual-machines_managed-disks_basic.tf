...
# Title: Basic Virtual Machine using a Managed Disk
# Description: This example provisions a Virtual Machine with a Managed Disk as the main OS Disk (and no External Data Disks).
