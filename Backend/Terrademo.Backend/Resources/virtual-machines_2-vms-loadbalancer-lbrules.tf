...
# Title: Virtual Machines : 2 Vms Loadbalancer Lbrules
# Description: # Create 2 Virtual Machines under a Load balancer and configures Load Balancing rules for the VMs
