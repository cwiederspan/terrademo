...
# Title: Virtual Machine with Managed Disks from a Custom Image
# Description: This example provisions a Virtual Machine with Managed Disks from a Custom Image that already exists.
