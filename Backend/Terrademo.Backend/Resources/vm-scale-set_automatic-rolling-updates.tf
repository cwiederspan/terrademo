...
# Title: Virtual Machine Scale Set with Rolling Automatic Updates
# Description: This example provisions a Virtual Machine Scale Set with Managed Disks and Rolling Automatic Updates configured.
